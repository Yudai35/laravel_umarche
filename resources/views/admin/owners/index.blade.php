                                        ...
                                        <tr>
                                            ...
                                            <td class="md:px-4 py-3 ">
                                                <button
                                                    ...
                                                    class="text-white bg-indigo-400 border-0 py-2 md:px-4 focus:outline-none hover:bg-indigo-600 rounded ">編集</button>
                                            </td>
                                            <form id="delete_{{ $owner->id }}" method="post"
                                                ...
                                                <td class="px-4 py-3 ">
                                                    <a href="#" data-id="{{ $owner->id }}" onclick="deletePost(this)"
                                                        class=" text-white bg-red-400 border-0 py-2 px-4
                                                    focus:outline-none hover:bg-red-600 rounded ">削除</a>
                                                </td>
                                            </form>
                                        </tr>
                                        @endforeach
